...
def test_construct_version_info():
    ...
    # It does test that the __version__ attribute is set on calamity.

    # this line is modified from the main implementation since we're in calamity/tests/
    calamity_dir = os.path.dirname(os.path.dirname(os.path.realpath(__file__)))
